...
def calculate_fraud_score(input_embedding, threshold=0.8, top_n=1):
    ...
    # Calculate similarity scores by inverting distances (lower distance means
    # higher similarity)
...
def create_embeddings_batch_ollama(text_batch):
    ...
    for text in text_batch:
        ...
        # Store only the embedding (numeric vector)
...
def main():
    ...
    print(
        f"Is Fraudulent: {
            'Yes' if fraud_score_result['is_fraud'] else 'No'}")
